import '../../../data/models/feature/customer/get_kokyaku_detail_request.dart';
import '../../../data/models/feature/customer/get_kokyaku_detail_response.dart';
import '../../../data/models/feature/customer/get_kokyaku_list_request.dart';
import '../../../data/models/feature/customer/get_kokyaku_list_response.dart';
import '../../../data/models/feature/customer/set_kokyaku_edit_request.dart';
import '../../../data/models/set_edit_response.dart';
...
/// [作成日] :2024/11/25
/// -----------------------------------------------
abstract class KokyakuRepository {
  /// 顧客一覧を取得します
  ///
  /// 引数:
  /// * [request] - 顧客一覧取得のためのリクエストパラメータ
  ///
  /// 戻り値:
  ...
  ///
  /// 引数:
  /// * [request] - 顧客詳細情報取得のためのリクエストパラメータ
  ///
  /// 戻り値:
